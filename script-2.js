$(document).ready(function() {
	...
	$("#add").on("click", function() {
		...
		// var newLine = $("#uncategorized-ul").add("li");

		// $("#uncategorized-ul").append('<li/>').text("hello");
		var line = $("<div/>").addClass("remove");
		// var div = $("<div/", {class: "remove"});

		line.appendTo("#uncategorized-ul");
